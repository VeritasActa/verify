...
export function detectFormat(input) {
  ...
  if (input.type === 'scopeblind.repository.coding-evidence.v1') return { mode: 'repository-evidence', signals: ['type=scopeblind.repository.coding-evidence.v1'], hasSelectiveDisclosure: false, isBundle: false };
